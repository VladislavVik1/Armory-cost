...
// Для Linux‑окружения; на Windows для тестирования можно указать другой путь
const FILE_PATH = "C:\Users\Lenovo\Documents\GitHub\Armory-cost\orders.json";
...
app.post("/get-orders", async (req, res) => {
  ...
  // Проверяем, что тело запроса соответствует ожиданиям
